...
.pp-progress{display:grid;grid-template-columns:repeat(4,minmax(0,1fr))!important;align-items:stretch;min-width:0;width:100%;margin:0;padding:0;background:linear-gradient(180deg,rgba(11,28,38,.96),rgba(6,18,26,.96));border:1px solid var(--line);border-radius:12px;overflow:hidden;box-shadow:0 8px 24px #0004}
.pp-step{position:relative;min-height:70px;min-width:0;border:0;background:transparent;color:var(--muted);padding:10px 42px 10px 18px;display:flex;align-items:center;justify-content:center;gap:12px;font:700 13px Inter,Segoe UI,system-ui,sans-serif;cursor:pointer;transition:background .18s ease,color .18s ease;outline:none}
...
.pp-step-copy{min-width:0;overflow:hidden;text-align:left;line-height:1.15}.pp-step-copy strong{display:block;font-size:13px;color:inherit}.pp-step-copy span{display:block;margin-top:4px;font-size:10px;font-weight:500;color:var(--muted)}
