...
const currencies={
 GBP:{symbol:'£',locale:'en-GB',rate:1},EUR:{symbol:'€',locale:'de-DE',rate:1.1663},USD:{symbol:'
...
})();,locale:'en-US',rate:1.3370},PLN:{symbol:'zł',locale:'pl-PL',rate:5.0892},CAD:{symbol:'CA
const moneyFields=['materialPackCost','labourRate','pack','other','electricityRate','fixedFee','delivery','deliveryCharge','sell'];
const unitFields=['materialPack','materialUsed'];
const tx={
'Settings':'Ustawienia','Manage the calculator display and preferences.':'Zarządzaj wyglądem kalkulatora i preferencjami.',
...
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',boot,{once:true});else boot();
})();,locale:'en-CA',rate:1.84},AUD:{symbol:'A
const moneyFields=['materialPackCost','labourRate','pack','other','electricityRate','fixedFee','delivery','deliveryCharge','sell'];
const unitFields=['materialPack','materialUsed'];
const tx={
'Settings':'Ustawienia','Manage the calculator display and preferences.':'Zarządzaj wyglądem kalkulatora i preferencjami.',
...
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',boot,{once:true});else boot();
})();,locale:'en-AU',rate:2.00},CHF:{symbol:'CHF',locale:'de-CH',rate:0.96},SEK:{symbol:'kr',locale:'sv-SE',rate:14.75},NOK:{symbol:'kr',locale:'nb-NO',rate:14.70},DKK:{symbol:'kr',locale:'da-DK',rate:8.69},CZK:{symbol:'Kč',locale:'cs-CZ',rate:28.30},JPY:{symbol:'¥',locale:'ja-JP',rate:179.00},CNY:{symbol:'¥',locale:'zh-CN',rate:9.65},INR:{symbol:'₹',locale:'en-IN',rate:123.50},NZD:{symbol:'NZ
const moneyFields=['materialPackCost','labourRate','pack','other','electricityRate','fixedFee','delivery','deliveryCharge','sell'];
const unitFields=['materialPack','materialUsed'];
const tx={
'Settings':'Ustawienia','Manage the calculator display and preferences.':'Zarządzaj wyglądem kalkulatora i preferencjami.',
...
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',boot,{once:true});else boot();
})();,locale:'en-NZ',rate:2.16},SGD:{symbol:'S
const moneyFields=['materialPackCost','labourRate','pack','other','electricityRate','fixedFee','delivery','deliveryCharge','sell'];
const unitFields=['materialPack','materialUsed'];
const tx={
'Settings':'Ustawienia','Manage the calculator display and preferences.':'Zarządzaj wyglądem kalkulatora i preferencjami.',
...
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',boot,{once:true});else boot();
})();,locale:'en-SG',rate:1.71},BRL:{symbol:'R
const moneyFields=['materialPackCost','labourRate','pack','other','electricityRate','fixedFee','delivery','deliveryCharge','sell'];
const unitFields=['materialPack','materialUsed'];
const tx={
'Settings':'Ustawienia','Manage the calculator display and preferences.':'Zarządzaj wyglądem kalkulatora i preferencjami.',
...
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',boot,{once:true});else boot();
})();,locale:'pt-BR',rate:7.18},MXN:{symbol:'MX
const moneyFields=['materialPackCost','labourRate','pack','other','electricityRate','fixedFee','delivery','deliveryCharge','sell'];
const unitFields=['materialPack','materialUsed'];
const tx={
'Settings':'Ustawienia','Manage the calculator display and preferences.':'Zarządzaj wyglądem kalkulatora i preferencjami.',
...
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',boot,{once:true});else boot();
})();,locale:'es-MX',rate:23.0696},ZAR:{symbol:'ZAR',locale:'en-ZA',rate:21.8000}
};
const moneyFields=['materialPackCost','labourRate','pack','other','electricityRate','fixedFee','delivery','deliveryCharge','sell'];
const unitFields=['materialPack','materialUsed'];
const tx={
