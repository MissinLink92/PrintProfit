...
function install(){
  ...
  style.textContent=`
    /* Premium circular icon treatment inspired by the PrintProfit reference */
    .head>.pp-pretty-icon,
    .merge-block .head>.pp-pretty-icon{
      ...
      border:2px solid rgba(255,120,0,.66)!important;
    ...
    .merge-block .head>.pp-pretty-icon::before{
      ...
      border:1px solid rgba(255,120,0,.12)!important;
    ...
    .merge-block .head>.pp-pretty-icon::after{
      ...
      transform:translateX(-70%) rotate(12deg)!important;
    ...
    .merge-block .head>.pp-pretty-icon svg{
      position:relative!important;z-index:2!important;width:29px!important;height:29px!important;
      fill:none!important;stroke:#ff8a24!important;stroke-width:1.8!important;stroke-linecap:round!important;stroke-linejoin:round!important;
      filter:drop-shadow(0 0 7px rgba(255,120,0,.34))!important;
    }
    .head>.pp-pretty-icon[data-icon-number="3"] svg{stroke-width:1.62!important}
    .head>.pp-pretty-icon[data-icon-number="4"] svg{stroke-width:1.68!important}
    .head>.pp-pretty-icon[data-icon-number="6"] svg{stroke-width:1.55!important}
    
    /* Smaller circular treatment for nested section headers */
    .merge-block .head>.pp-pretty-icon{width:44px!important;height:44px!important;min-width:44px!important}
    .merge-block .head>.pp-pretty-icon svg{width:26px!important;height:26px!important}
    
    @media(max-width:650px){
      .head>.pp-pretty-icon{width:44px!important;height:44px!important;min-width:44px!important}
      .head>.pp-pretty-icon svg{width:26px!important;height:26px!important}
      .merge-block .head>.pp-pretty-icon{width:40px!important;height:40px!important;min-width:40px!important}
      .merge-block .head>.pp-pretty-icon svg{width:24px!important;height:24px!important}
    }
