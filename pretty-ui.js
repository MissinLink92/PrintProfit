(()=>{
  ...
  function installGlobalPolish(){
    ...
    if(mode){mode.classList.add('pp-mode-toggle');mode.innerHTML='☾ <span>Dark Mode</span> <input id="dark" type="checkbox" role="switch" checked>' ;}
  }
...
.pp-hero-art{position:absolute;z-index:3;right:0;top:0;width:min(31vw,360px);height:205px;display:flex;justify-content:flex-end;align-items:flex-end;pointer-events:none}.pp-hero-art img{width:270px;height:205px;object-fit:contain;object-position:right center;display:block;filter:drop-shadow(0 12px 24px #0009)}
...
.result.pp-results-enhanced{border-color:#284657;box-shadow:0 14px 40px #0007}
.pp-tabs{box-shadow:0 8px 28px #0005}
.pp-global-actions{box-shadow:0 10px 26px #0005}
.panel{box-shadow:0 4px 18px #0002}
.footer{background:#050b10;border-top-color:#193342}
